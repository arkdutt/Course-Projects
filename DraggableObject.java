...
/**
 * 
 * This class models a draggable object. A draggable object is a clickable
 * interactive object which can follow the mouse moves when being dragged.
 *
 */
...
public class DraggableObject extends InteractiveObject {
	...
	/**
	 * 
	 * Creates a new Draggable object with a given name, x and y position, and "Drag
	 * Me!" as a default message.
	 * 
	...
	/**
	 * 
	 * Draws this draggable object to the display window. If this object is
	 * dragging, this method sets its position to follow the mouse moves. Then, it draws its image to the its
	 * current position.
	 * 
	 */
	@Override
	...
	/**
	 * 
	 * Starts dragging this object when it is clicked (meaning when the mouse is
	 * over it)
	 * 
	 */
	@Override
