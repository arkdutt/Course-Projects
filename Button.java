...
public class Button implements Clickable {
	...
	// Note that the position (x,y) of this button is the position of its left upper
	// corner
	...
	public boolean isMouseOver() {
		if (processing.mouseX > (this.x + this.WIDTH) || processing.mouseX < this.x)
			return false;
		if (processing.mouseY > (this.y + this.HEIGHT) || processing.mouseY < this.y)
			return false;
		return true;
	}
}