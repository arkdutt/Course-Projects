...
/** 
 * 
 * This class models a droppable object designed for the cs300 spring 2022 p05
 * Treasure Hunt adventure style game application.
 * 
 */
...
public class DroppableObject extends DraggableObject {
	 ...
	 * 
	 * 
	 * @param other - reference to another iteractive object. We assume that other
	 *              is NOT null.
	 * @return reference to another iteractive object. We assume that other is NOT
	 *         null.
	 * 
	 */
	...
	/**
	 * 
	 * Stops dragging this droppable object. Also, if this droppable object is over
	 * its target and the
	 * target is activated, this method (1) deactivates both this object and its
	 * target, (2) activates
	 * the next clue, and (3) prints the message of this draggable object to the
	 * console.
	 * 
	 */
	@Override
